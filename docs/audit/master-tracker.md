...
|---|---|---|---|---|
| **P1** 자동 루프 (영상 안 바뀜) | ✅ 80% (cron 후 검증) | 80% (변동 없음) | — | — |
| **P2** 데이터 양 부족 (10일 3000개 미만) | ⚠️ 50% | 50% (G1.5 백로그) | — | — |
| **P3** UI 메타/화질/댓글 | ✅ 90% | 90% (댓글 proxy 미구현) | — | — |
| **P4** 홈 신선도 (218주, 라벨 거짓) | ✅ 95% | ✅ 95% (회귀 없음) | — | — |
| **P5** 탭 중복 (떡상↔급상승↔인사이트↔랭킹) | ⚠️ 20% (설계만) | ✅ 65% (옵션 C 구현) | — | — |
...
#### P5 (65%) — cycle2 옵션 C 구현 완료
- ✅ Phase 1: 홈 급상승 섹션 (국가탭 + Shorts/Long 필터) 확장
- ✅ Phase 2: /rising 탭 제거 + / redirect (commit 353aac5)
- ✅ Phase 3: 라벨 명확화 — "🔥 떡상 (현재)" / "📊 인사이트 (분석)"
- ✅ 급상승 섹션 bug fix — ALL탭 Shorts 포함, NULL subscriber_count fallback
- ⚠️ 롱폼 급상승 데이터 0개 (0905-2차 백로그: YouTube Search API 롱폼 수집)
- ⚠️ /trending-live 현재 mock 데이터 사용 (라벨만 추가, 데이터 연동 미구현)
...
- 2026-05-12: cycle2 종료 — P5 20%→65% (옵션 C Phase1-3 완료)
