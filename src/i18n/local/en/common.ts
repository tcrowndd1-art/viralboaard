const translations = {
  ...
  nav_charts: 'Charts',
  nav_insights: '📊 Insights (Analysis)',
  nav_trending_live: '🔥 Trending Now',
  trending_live_page_desc: 'Videos exploding in views right now (vs. subscriber count)',
  insights_page_desc: 'Viral patterns from the last 90 days + micro channel analysis',
